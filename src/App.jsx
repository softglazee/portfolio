    ...
    <div className="print-hidden bg-slate-950 text-slate-200 min-h-screen overflow-x-hidden font-sans">
      ...
      <section id="hero" className="min-h-screen relative flex items-center justify-center px-6 md:px-12 py-20 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto flex flex-col items-center text-center">
          ...
          <div className="relative w-[260px] h-[260px] md:w-[300px] md:h-[300px] flex items-center justify-center mb-8 animate-scaleIn delay-1">
          ...
          <p className="font-mono text-xs md:text-sm text-slate-500 mb-8 flex flex-wrap gap-x-2 justify-center animate-fadeUp delay-3">
          ...
          <div className="flex flex-wrap gap-3 mb-10 justify-center animate-fadeUp delay-5">
          ...
          <div className="flex gap-3 mb-8 justify-center animate-fadeUp delay-5 flex-wrap">
            ...
            <a href="https://www.linkedin.com/in/azharalidev/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg border border-slate-700 hover:border-cyan-400 hover:text-cyan-400 text-slate-400 flex items-center justify-center transition-all hover:-translate-y-0.5" title="LinkedIn">
              <Linkedin size={16} />
            </a>
            <a href="https://chromewebstore.google.com/detail/softglaze-screen-recorder/ofjommapkklakbolagajoiklgfldhlmp" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg border border-slate-700 hover:border-purple-400 hover:text-purple-400 text-slate-400 flex items-center justify-center transition-all hover:-translate-y-0.5" title="Chrome Extension">
              <Chrome size={16} />
            </a>
            <a href="https://softglaze.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg border border-slate-700 hover:border-cyan-400 hover:text-cyan-400 text-slate-400 flex items-center justify-center transition-all hover:-translate-y-0.5" title="SoftGlaze">
              <Globe size={16} />
            </a>
          </div>
      ...
      <AnimatedSection id="why" tag="// hire(me) === true" icon={<Heart />} number="04">
        ...
        <div className="grid md:grid-cols-2 gap-5 max-w-6xl mx-auto mb-10">
          ...
          {/* Me */}
          <div className="glass rounded-xl p-6 relative overflow-hidden border border-cyan-400/30">
          ...
          {[
            {
              ...
              desc: '20+ production sites. 1 Chrome extension on the Web Store. Real users hitting real endpoints. Not a portfolio of half-finished side projects.',
              color: 'cyan'
            },
            {
              icon: Cpu,
            ...
            },
            {
              ...
              desc: 'PR reviews, mentoring, refactoring spaghetti into structure. The team you hand me to will be better off in 6 months than they are today.',
              color: 'pink'
            },
            {
              icon: Globe2,
              ...
              desc: '4+ years working with US clients while based in Pakistan. I know how to communicate async, document decisions, and not drop the ball when nobody\'s watching.',
              color: 'green'
            },
            {
              icon: Wrench,
            ...
            {
              icon: Coffee,
              title: 'I\'m in this for the long run.',
              code: 'commit --signoff',
              desc: 'Done with agency context-switching. I\'m looking for one team to commit to deeply. If you\'re building something interesting, I\'m all in.',
              color: 'orange'
            },
          ].map((card, i) => {
        ...
        <div className="max-w-3xl mx-auto mt-10 text-center">
          ...
          <a href="mailto:admin@softglaze.com" className="inline-flex items-center gap-2 mt-6 px-6 py-3 rounded-lg bg-gradient-to-r from-cyan-500 to-purple-500 text-white font-medium text-sm hover:shadow-xl hover:shadow-cyan-500/30 transition-all hover:-translate-y-0.5">
            <Heart size={16} /> Let's talk about your role
            <ArrowUpRight size={14} />
          </a>
        </div>
      </AnimatedSection>
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-4 px-2">
          {statusFilters.map((sf) => {
            ...
            return (
              ...
              >
                <Icon size={12} className={isActive && sf.id === 'featured' ? 'fill-yellow-400 text-yellow-400' : ''} />
                {sf.label} ({count})
              </button>
            );
          })}
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 text-left">
          {filteredPortfolio.map((site, i) => {
            ...
            return (
              <div
                key={site.url}
                className={`glass rounded-xl p-5 relative overflow-hidden cursor-pointer ${isExpanded ? 'border-cyan-400/40 lg:col-span-3 sm:col-span-2' : 'hover:-translate-y-1 hover:border-cyan-400/40'}`}
              ...
              >
                ...
                <div className="text-xs text-slate-400 leading-snug mb-3">{site.desc}</div>
